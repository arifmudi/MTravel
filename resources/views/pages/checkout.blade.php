            ...
            <div class="row">
                    ...
                    <div class="card card-details">
                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="https://ui-avatars.com/api/?name={{ $detail->username }}" alt="{{ $detail->username }}" height="60px" class="rounded-circle" />
                                        </td>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                ...
                                <input type="text" name="username" class="form-control mr-sm-2 mb-2" id="username" placeholder="Username" required />

                                <label for="nationality" class="sr-only">Nationality</label>
                                <input type="text" name="nationality" class="form-control mr-sm-2 mb-2" style="width: 50px" id="nationality" required  placeholder="Nationality" />
                ...
                <option value="0">N/A</option>
                                ...
                                <div class="mb-2 mr-sm-2 input-group">
                                    <input class="form-control datepicker" id="doe_passport" name="doe_passport" placeholder="DOE Passport" />
                                </div>
