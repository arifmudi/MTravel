                                    ...
                                    <div class="xzoom-thumbs">
                                        @foreach ($item->galleries as $gallery)
                                            <a href="{{ Storage::url($gallery->image) }}">
                                                <img src="{{ Storage::url($gallery->image) }}" alt="image 1"
                                                    class="xzoom-gallery" height="80px" width="120px"
                            ...
                            <div class="features row">
                                <div class="col-md-4">
                                    <div class="description">
                                        <img src="{{ url('frontend/images/tiket.png') }}" alt="Tiket"
                                ...
                                <div class="col-md-4 border-left">
                                    <div class="description">
                                        <img src="{{ url('frontend/images/ic_language.png') }}" alt="Bahasa"
                                            class="features-image" />
                                        <div class="description">
                                            <h3>Language</h3>
                                            <p>{{ $item->language }}</p>
                                ...
                                <div class="col-md-4 border-left">
                                    <div class="description">
                                        <img src="{{ url('frontend/images/ic_foods.png') }}" alt="Makanan"
                                            class="features-image" />
                                        <div class="description">
                                            <h3>Foods</h3>
                                            <p>{{ $item->foods }}</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                <img src="{{ url('frontend/images/Mask Group 3.png') }}" alt="member"
